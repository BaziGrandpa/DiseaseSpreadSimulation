...
def init_all_buildings():
    buildings = {}
    building1 = Building(name="Cafeteria", position=[(501, 401), (618, 404), (621, 451), (498, 467)],text_position=[563, 480], maximum_number=Settings.max_capacity_caffeteria*Settings.public_distancing_precentage)
    building2 = Building(name="Library", position=[(497, 197), (423, 179), (427, 138), (504, 145)], text_position=[473, 133], maximum_number=Settings.building_capacity)
    building3 = Building(name="Physics Building", position=[(355, 277), (478, 281), (478, 350), (353, 337)], text_position=[415, 360], maximum_number=Settings.building_capacity)
    building4=  Building(name="HB", position=[(590, 162), (594, 193), (674, 196), (669, 163)], text_position=[632, 143], maximum_number=Settings.building_capacity)
    building5=  Building(name="Chemistry", position=[(400, 260), (405, 170), (345, 180),(350, 265)], text_position=[373, 162], maximum_number=Settings.building_capacity)
    ...
    building7 = Building(name="Computer science and Engineering", position=[(728, 204), (789, 200), (795, 274),(728, 281)], text_position=[761, 290], maximum_number=Settings.building_capacity)
    building8 = Building(name="Machine", position=[(663, 204), (667, 296), (561, 295),(561, 204)], text_position=[591, 307], maximum_number=Settings.building_capacity)
